...
class Tenant(BaseModel):
    ...
    profile_review_status = models.CharField(
        max_length=20,
        choices=ProfileReviewStatus.CHOICES,
        default=ProfileReviewStatus.DRAFT,
        db_index=True,
    )
    ...
    def mark_approved(self):
        ...
        self.profile_review_status = ProfileReviewStatus.APPROVED
        self.approved_at = timezone.now()
        self.save(
            update_fields=['status', 'profile_review_status', 'approved_at', 'updated_at']
        )

    @property
    def is_profile_locked(self):
        return self.profile_review_status == ProfileReviewStatus.SUBMITTED
