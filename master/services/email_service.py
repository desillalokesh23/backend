...
def send_profile_review_notification(tenant):
    """Placeholder when tenant submits profile for super admin review."""
    logger.info(
        'EMAIL PLACEHOLDER: Profile submitted for review — %s (%s)',
        tenant.company_name,
        tenant.tenant_code,
    )
